...
typedef struct ms_ecall_function_calling_convs_t {
	int ms_retval;
} ms_ecall_function_calling_convs_t;
...
sgx_status_t ecall_function_calling_convs(sgx_enclave_id_t eid, int* retval)
{
	sgx_status_t status;
	ms_ecall_function_calling_convs_t ms;
